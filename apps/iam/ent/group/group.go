...
const (
	...
	OrgColumn = "org_groups"
	// UsersTable is the table that holds the users relation/edge. The primary key declared below.
	UsersTable = "group_users"
	// UsersInverseTable is the table name for the User entity.
	// It exists in this package in order to avoid circular dependency with the "user" package.
	UsersInverseTable = "users"
	// AuthoritiesTable is the table that holds the authorities relation/edge. The primary key declared below.
	AuthoritiesTable = "group_authorities"
...
var (
	...
	// AuthoritiesPrimaryKey and AuthoritiesColumn2 are the table columns denoting the
	// primary key for the authorities relation (M2M).
	AuthoritiesPrimaryKey = []string{"group_id", "authority_id"}
)
